 ...
 * W25Q128 ID  0XEF17
*/
#define DEVICE_W25QXX_ID	    0XEF16

/**数据块数量 */
#define DEVICE_W25QXX_BLOCK_NUM		    128
...
static void DeviceW25QXX_IOInit(void)
{
    ...
    /**初始化SPI */
    CoreSPI2Init(DEVICE_W25QXX_CPOL,DEVICE_W25QXX_CPHA,DEVICE_W25QXX_SPEED);
}
...
static uint8_t DeviceW25QXXReadSR(void)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送读取状态寄存器命令 */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_READ_STATUS_REG);
    /**读取一个字节*/
    result=CoreSPI2WriteRead(0Xff);
    /**取消片选 */
    DeviceW25QXXSetCS(1);
    return result;
}
...
void DeviceW25QXXWriteSR(uint8_t statusRegVal)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送写取状态寄存器命令  */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_WRITE_STATUS_REG);
    /**写入一个字节 */
    CoreSPI2WriteRead(statusRegVal);
    /**取消片选 */
    DeviceW25QXXSetCS(1);
}
...
static void DeviceW25QXXWriteEnable(void)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送写使能  */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_WRITE_ENABLE);
    /**取消片选 */
    DeviceW25QXXSetCS(1);
}
...
void DeviceW25QXXWriteDisable(void)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送写禁止  */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_WRITE_DISABLE);
    /**取消片选 */
    DeviceW25QXXSetCS(1);
}
...
static uint16_t DeviceW25QXXReadID(void)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送读取ID命令*/
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_MANUFACT_DEVICEID);
    CoreSPI2WriteRead(0x00);
    CoreSPI2WriteRead(0x00);
    CoreSPI2WriteRead(0x00);
    temp += CoreSPI2WriteRead(0xFF);
    temp <<= 8;
    temp += CoreSPI2WriteRead(0xFF);
    /**取消片选 */
    DeviceW25QXXSetCS(1);
...
static uint8_t DeviceW25QXXWritePage(uint8_t* pBuffer,uint32_t writeAddr,uint16_t numByteToWrite)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送写页命令 */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_PAGE_PROGRAM);
    /**发送24bit地址 */
    CoreSPI2WriteRead((uint8_t)((writeAddr)>>16));
    CoreSPI2WriteRead((uint8_t)((writeAddr)>>8));
    CoreSPI2WriteRead((uint8_t)writeAddr);
    for(i=0;i<numByteToWrite;i++)
    {
        /**循环写数  */
        CoreSPI2WriteRead(pBuffer[i]);
    }
    /**取消片选 */
    DeviceW25QXXSetCS(1);
    /**等待写入结束 */
...
void DeviceW25QXXEraseChip(void)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送片擦除命令  */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_CHIP_ERASE);
    /**取消片选     */
    DeviceW25QXXSetCS(1);
    /**等待芯片擦除结束*/
    DeviceW25QXXWaitBusy();
...
void DeviceW25QXXEraseSector(uint32_t dstAddr)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送扇区擦除指令  */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_SECTOR_ERASE);
    /**发送24bit地址  */
    CoreSPI2WriteRead((u8)((dstAddr)>>16));
    CoreSPI2WriteRead((u8)((dstAddr)>>8));
    CoreSPI2WriteRead((u8)dstAddr);
    /**取消片选  */
    DeviceW25QXXSetCS(1);
    /**等待擦除完成*/
    DeviceW25QXXWaitBusy();
...
void DeviceW25QXXPowerDown(void)
{
    ...
    DeviceW25QXXSetCS(0);
    /**发送掉电命令 */
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_POWER_DOWN);
    /**取消片选  */
    DeviceW25QXXSetCS(1);
    /**等待TPD */
    CoreTickDelayMs(3);
...
void DeviceW25QXXWakeUp(void)
{
    /**使能器件 */
    DeviceW25QXXSetCS(0);
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_POWER_ON);
    DeviceW25QXXSetCS(1);
    CoreTickDelayMs(3);
}
...
uint8_t DeviceW25QXXRead(uint8_t* pBuffer,uint32_t readAddr,uint16_t numByteToRead)
{
    ...
    if(readAddr+numByteToRead >= DEVICE_W25QXX_ADDR_MAX)
        return 1;
    /**设置SPI接口道系统指定模式 */
    CoreSPI2SetCp(DEVICE_W25QXX_CPOL,DEVICE_W25QXX_CPHA);
    CoreSPI2SetSpeed(DEVICE_W25QXX_SPEED);
    /**使能器件 */
    DeviceW25QXXSetCS(0);
    CoreSPI2WriteRead(DEVICE_W25QXX_COMMAND_READ_DATA);
    /**发送24bit地址  */
    CoreSPI2WriteRead((uint8_t)((readAddr)>>16));
    CoreSPI2WriteRead((uint8_t)((readAddr)>>8));
    CoreSPI2WriteRead((uint8_t)readAddr);
    for(i=0;i<numByteToRead;i++)
    {
        pBuffer[i] = CoreSPI2WriteRead(0XFF);
    }
    /**取消片选 */
    DeviceW25QXXSetCS(1);
    return 0;
...
uint8_t DeviceW25QXXWrite(uint8_t* pBuffer,uint32_t writeAddr,uint16_t numByteToWrite)
{
    ...
    {
        /**读出整个扇区的内容 */
        DeviceW25QXXRead(deviceW25QXXBuffer,secpos*(DEVICE_W25QXX_PAGE_SIZE*DEVICE_W25QXX_PAGE_NUM),DEVICE_W25QXX_PAGE_SIZE*DEVICE_W25QXX_PAGE_NUM);
        /**校验数据,初始化擦除之后是0XFF */
