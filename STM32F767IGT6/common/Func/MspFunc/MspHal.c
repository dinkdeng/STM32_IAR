...
//     Fusb=432/9=48Mhz
//返回值:0,成功;1,失败
void SystemClockInitPLL(uint32_t plln,uint32_t pllm,uint32_t pllp,uint32_t pllq)
{
...
{
    //设置时钟,216Mhz
    /**25/25*432/2 = 216MHZ APB2 108 APB1 54 USB 25/25*432/9 = 48MHZ */
    SystemClockInitPLL(432,25,2,9);
}
